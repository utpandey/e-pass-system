	...
	return (
		<div className="visitor__cont">
			<div className="visitor__cont__headerCont">
				...
				<h1 className="visitor__cont__headerCont__info">Dashboard / Vistiors</h1>
			</div>
			<div className="visitor__cont__mainCont">
				<button className="visitor__cont__mainCont__btn" onClick={() => setModal((prevValue) => !prevValue)}>
					+ Add Visitor
				</button>
						...
						<div className="table-content">
							{visitors.map((data, index) => (
								<div className="table-row" key={index}>
									...
									<div className="table-data">{data.vaccinated ? 'Done' : 'Not Yet'}</div>
			...
			{showModal && <VisitorDetails showModal={showModal} setModal={setModal} />}
		</div>
	);
}
